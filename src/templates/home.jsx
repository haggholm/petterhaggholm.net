<div class="text-justify" style="margin-top: 5ex;">
    <p class="lead">
        Welcome to the website of the one and only Petter Häggholm, who believes
        that the personal website isn’t all dead, only
        <a href="https://www.youtube.com/watch?v=D9tAKLTktY0#t=1m49s">mostly dead</a>.
    </p>

    <p>
        Here you’ll find information about <a href="/aboutme">about me</a>
        and some of my <a href="/gallery">artwork</a>.
        You can also grab my
        <a href="{{ staticRoot }}misc/petter_haggholm_resume.pdf" target="_blank">
            résumé <i class="fa fa-download"></i></a>
        and my
        <a href="{{ staticRoot }}misc/petterhaggholm.net-0x892C8636-pub.asc"
